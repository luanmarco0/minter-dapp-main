...
const welcome_h1 = "Welcome to the SliceWar Metaverse";
const welcome_h2 = "Connect to MetaMask to Get your Slogger";
...
const h1_presale_coming_soon = "First © SliceWar Drop Coming Soon!!";
